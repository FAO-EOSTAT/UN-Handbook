...
knitr::include_graphics("./images/th_machine_learning/random_forest.png") 
```
...
knitr::include_graphics("./images/th_machine_learning/mlrformodel.png") 
```
...
knitr::include_graphics("./images/th_machine_learning/mlrforplot.png") 
```
...
knitr::include_graphics("./images/th_machine_learning/flow_chart_xgboost.png") 
```
...
knitr::include_graphics("./images/th_machine_learning/mlxgbplot.png") 
```
...
knitr::include_graphics("./images/th_machine_learning/mlmlpmodel.png") 
```
...
knitr::include_graphics("./images/th_machine_learning/mlmlpplot.png") 
```
...
knitr::include_graphics("./images/th_machine_learning/tempcnn.png")
```
...
knitr::include_graphics("./images/th_machine_learning/mltcnnmodel.png")
```
...
knitr::include_graphics("./images/th_machine_learning/mltcnnplot.png")
```
...
knitr::include_graphics("./images/th_machine_learning/resnet.png")
```
...
knitr::include_graphics("./images/th_machine_learning/mlresnetmodel.png")
```
...
#| fig.cap: |
#|   Classification of time series using TempCNN
knitr::include_graphics("./images/th_machine_learning/mlresnetplot.png")
```
...
knitr::include_graphics("./images/th_machine_learning/mltaemodel.png")
```
...
knitr::include_graphics("./images/th_machine_learning/mltaeplot.png")
```
...
knitr::include_graphics("./images/th_machine_learning/mlltaemodel.png")
```
...
knitr::include_graphics("./images/th_machine_learning/mlltaeplot.png")
```
