---
title: "Spatial map uncertainty estimation"
...
tempdir_r <- "~/UN-Handbook/tempdir/R/uncertainty"
...
knitr::include_graphics("./images/th_uncertainty/active_learning.png")
```
...
knitr::include_graphics("./images/th_uncertainty/samuel_dam.png")
```
